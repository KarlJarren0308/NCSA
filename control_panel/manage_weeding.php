        ...
        <div class="row" style="height: 100%;">
            <div id="cell-sidebar" class="cell bg-lightDark size-x300" style="overflow-y: scroll; height: 100%;">
                <ul class="sidebar2 dark">
                    ...
                    <li class="active"><a href="./manage_weeding.php"><span class="mif-books mif-ani-shuttle icon"></span><span class="title">Manage Weeded Materials</span></a></li>
            ...
            <div id="cell-content" class="cell auto-size padding20 pane-scroll">
                <h1 class="text-light">Manage Weeded Materials</h1>
                <hr><br>
                <table id="materials-table" class="table striped border bordered">
                    ...
                    <tbody>
                        <?php
                            ...
                            $connection->query("SELECT * FROM weeding INNER JOIN materials ON weeding.Material_ID=materials.Material_ID WHERE materials.Status='inactive' GROUP BY materials.Material_Title");
                            ...
                            while($row = $connection->fetch_assoc()) {
                                ...
                                echo '<td class="align-center"><a class="button primary mini-button beautify" data-button="restore-material-button" data-var-id="' . $row['Material_ID'] . '" data-role="hint" data-hint="Restore Material" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-loop2"></span></a></td>';
                                echo '</tr>';
                            }
