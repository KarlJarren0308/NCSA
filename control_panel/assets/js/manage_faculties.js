$(document).ready(function() {
    $('#faculties-table').dataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            $('[data-button="edit-faculty-button"]').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        setDialogHtmlContent('Edit Faculty', response);
                        ...
                        $('[data-form="edit-faculty-form"]').submit(function() {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    setDialogContent('Edit Faculty Status', response['message']);
            ...
            $('[data-button="delete-faculty-button"]').click(function() {
                ...
                setDialogLoader();
                openDialog();
                setDialogHtmlContent('Delete Faculty', '<div>Are you sure you want to delete this faculty?</div><div class="align-right"><button class="button" data-button="no-button">No</button>&nbsp;&nbsp;<button class="button danger" data-button="yes-button">Yes</button></div>');
                ...
                $('[data-button="yes-button"]').click(function() {
                    $.ajax({
                        ...
                        success: function(response) {
                            response = JSON.parse(response);
                            setDialogContent('Delete Faculty Status', response['message']);
    ...
    $('[data-button="add-faculty-button"]').click(function() {
        ...
        $.ajax({
            ...
            method: 'POST',
            success: function(response) {
                setDialogHtmlContent('Add Faculty', response);
                ...
                $('[data-form="add-faculty-form"]').submit(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            response = JSON.parse(response);
                            setDialogContent('Add Faculty Status', response['message']);
