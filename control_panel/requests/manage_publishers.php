<?php
    ...
    if($action == 'Add') {
        ...
        if($connection->num_rows() == 0) {
            $connection->query("INSERT INTO publishers (Publisher_Name) VALUES ('$publisher')");
        ...
        if($connection->num_rows() == 0) {
            $connection->query("UPDATE publishers SET Publisher_Name='$publisher' WHERE Publisher_ID='$id'");
