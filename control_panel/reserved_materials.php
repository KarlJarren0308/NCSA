        ...
        <div class="row" style="height: 100%;">
            <div id="cell-sidebar" class="cell bg-lightDark size-x300" style="overflow-y: scroll; height: 100%;">
                <ul class="sidebar2 dark">
                    ...
                    <li class="active"><a href="./reserved_materials.php"><span class="mif-history mif-ani-shuttle icon"></span><span class="title">Reserved Materials</span></a></li>
            ...
            <div id="cell-content" class="pane-scroll cell auto-size padding20 pane-scroll">
                <h1 class="text-light">Reserved Materials</h1>
                <hr><br>
                <div class="grid">
