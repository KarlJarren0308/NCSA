        ...
        <div class="row" style="height: 100%;">
            <div id="cell-sidebar" class="cell bg-lightDark size-x300" style="overflow-y: scroll; height: 100%;">
                <ul class="sidebar2 dark">
                    ...
                    <li class="active"><a href="./manage_holidays.php"><span class="mif-calendar mif-ani-shuttle icon"></span><span class="title">Manage Holidays</span></a></li>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = $connection->fetch_assoc()) {
                                ...
                                echo '<td>' . date('F d, Y', strtotime($row['Year'] . '-' . $row['Month'] . '-' . $row['Day'])) . '</td>';
